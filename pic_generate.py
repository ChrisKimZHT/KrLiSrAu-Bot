...
item_dict = {
    ...
    "天空之卷": [Image.open("./resource/weapon/天空之卷.png").convert(mode="RGBA"), 5, False, "法器"],
    "和璞鸢": [Image.open("./resource/weapon/和璞鸢.png").convert(mode="RGBA"), 5, False, "长柄"],
    "天空之脊": [Image.open("./resource/weapon/天空之脊.png").convert(mode="RGBA"), 5, False, "长柄"],
    "狼的末路": [Image.open("./resource/weapon/狼的末路.png").convert(mode="RGBA"), 5, False, "双手剑"],
    ...
    "早柚": [Image.open("./resource/character/早柚.png").convert(mode="RGBA"), 4, True, "风"],
    "托马": [Image.open("./resource/character/托马.png").convert(mode="RGBA"), 4, True, "火"],
    "烟绯": [Image.open("./resource/character/烟绯.png").convert(mode="RGBA"), 4, True, "火"],
    "罗莎莉亚": [Image.open("./resource/character/罗莎莉亚.png").convert(mode="RGBA"), 4, True, "冰"],
    "辛焱": [Image.open("./resource/character/辛焱.png").convert(mode="RGBA"), 4, True, "火"],
    "砂糖": [Image.open("./resource/character/砂糖.png").convert(mode="RGBA"), 4, True, "风"],
    "迪奥娜": [Image.open("./resource/character/迪奥娜.png").convert(mode="RGBA"), 4, True, "冰"],
    "重云": [Image.open("./resource/character/重云.png").convert(mode="RGBA"), 4, True, "冰"],
    "诺艾尔": [Image.open("./resource/character/诺艾尔.png").convert(mode="RGBA"), 4, True, "岩"],
    "班尼特": [Image.open("./resource/character/班尼特.png").convert(mode="RGBA"), 4, True, "火"],
    "菲谢尔": [Image.open("./resource/character/菲谢尔.png").convert(mode="RGBA"), 4, True, "雷"],
    "凝光": [Image.open("./resource/character/凝光.png").convert(mode="RGBA"), 4, True, "岩"],
    "行秋": [Image.open("./resource/character/行秋.png").convert(mode="RGBA"), 4, True, "水"],
    "北斗": [Image.open("./resource/character/北斗.png").convert(mode="RGBA"), 4, True, "雷"],
    "香菱": [Image.open("./resource/character/香菱.png").convert(mode="RGBA"), 4, True, "火"],
    "安柏": [Image.open("./resource/character/安柏.png").convert(mode="RGBA"), 4, True, "火"],
    "雷泽": [Image.open("./resource/character/雷泽.png").convert(mode="RGBA"), 4, True, "雷"],
    ...
    "西风猎弓": [Image.open("./resource/weapon/西风猎弓.png").convert(mode="RGBA"), 4, False, "弓箭"],
    "昭心": [Image.open("./resource/weapon/昭心.png").convert(mode="RGBA"), 4, False, "法器"],
    "祭礼残章": [Image.open("./resource/weapon/祭礼残章.png").convert(mode="RGBA"), 4, False, "法器"],
    "流浪乐章": [Image.open("./resource/weapon/流浪乐章.png").convert(mode="RGBA"), 4, False, "法器"],
    "西风秘典": [Image.open("./resource/weapon/西风秘典.png").convert(mode="RGBA"), 4, False, "法器"],
    "西风长枪": [Image.open("./resource/weapon/西风长枪.png").convert(mode="RGBA"), 4, False, "长柄"],
    "匣里灭辰": [Image.open("./resource/weapon/匣里灭辰.png").convert(mode="RGBA"), 4, False, "长柄"],
    "雨裁": [Image.open("./resource/weapon/雨裁.png").convert(mode="RGBA"), 4, False, "双手剑"],
    "祭礼大剑": [Image.open("./resource/weapon/祭礼大剑.png").convert(mode="RGBA"), 4, False, "双手剑"],
    "钟剑": [Image.open("./resource/weapon/钟剑.png").convert(mode="RGBA"), 4, False, "双手剑"],
    "西风大剑": [Image.open("./resource/weapon/西风大剑.png").convert(mode="RGBA"), 4, False, "双手剑"],
    "匣里龙吟": [Image.open("./resource/weapon/匣里龙吟.png").convert(mode="RGBA"), 4, False, "单手剑"],
    ...
    "翡玉法球": [Image.open("./resource/weapon/翡玉法球.png").convert(mode="RGBA"), 3, False, "法器"],
    "讨龙英杰谭": [Image.open("./resource/weapon/讨龙英杰谭.png").convert(mode="RGBA"), 3, False, "法器"],
    "魔导绪论": [Image.open("./resource/weapon/魔导绪论.png").convert(mode="RGBA"), 3, False, "法器"],
    "黑缨枪": [Image.open("./resource/weapon/黑缨枪.png").convert(mode="RGBA"), 3, False, "长柄"],
    "以理服人": [Image.open("./resource/weapon/以理服人.png").convert(mode="RGBA"), 3, False, "长柄"],
    "沐浴龙血的剑": [Image.open("./resource/weapon/沐浴龙血的剑.png").convert(mode="RGBA"), 3, False, "单手剑"],
    "铁影阔剑": [Image.open("./resource/weapon/铁影阔剑.png").convert(mode="RGBA"), 3, False, "单手剑"],
    "飞天御剑": [Image.open("./resource/weapon/飞天御剑.png").convert(mode="RGBA"), 3, False, "单手剑"],
    "黎明神剑": [Image.open("./resource/weapon/黎明神剑.png").convert(mode="RGBA"), 3, False, "单手剑"],
    "冷刃": [Image.open("./resource/weapon/冷刃.png").convert(mode="RGBA"), 3, False, "单手剑"]
}
# 页面背景
...
# 角色元素
elements = {
    "水": Image.open("./resource/misc/水.png").convert(mode="RGBA"),
    "火": Image.open("./resource/misc/火.png").convert(mode="RGBA"),
    "草": Image.open("./resource/misc/草.png").convert(mode="RGBA"),
    "风": Image.open("./resource/misc/风.png").convert(mode="RGBA"),
    "雷": Image.open("./resource/misc/雷.png").convert(mode="RGBA"),
    "冰": Image.open("./resource/misc/冰.png").convert(mode="RGBA"),
    "岩": Image.open("./resource/misc/岩.png").convert(mode="RGBA")
}
# 武器类型
weapon_type = {
...
# 星级
grade = {
    3: Image.open("./resource/misc/s-3.png").convert(mode="RGBA"),
    4: Image.open("./resource/misc/s-4.png").convert(mode="RGBA"),
    5: Image.open("./resource/misc/s-5.png").convert(mode="RGBA")
}
...
def gen_pic(result_list):
    ...
    for i in range(0, 10):
        if item_dict[result_list[i]][2]:
            ...
            # 嵌入角色元素
            element = elements[item_dict[result_list[i]][3]].resize((55, 55))
            ...
            # 嵌入武器类型
            typ = weapon_type[item_dict[result_list[i]][3]]
